...
export function Authenticity() {
    return (
        <div className="value-page">
            ...
            <h1 className="value-page-heading">AUTHENTICITY: Able to admit when they don't know</h1>
            ...
            <div className="value-page-container">
                ...
                <p className="value-page-text">This very project, inspired of course by our web development day during Career Lab, provides a good example of my ability to admit what I don't know. First, I'm pretty sure that "the React way" of building this page would not involve creating a different component for each of the values, as I did. Instead, I believe the correct approach would be to create a single reusable Value component that would accept different props for each value, and render it five times, thus preventing code duplication. I understand this concept, but knowing how to implement it is a skill I'm still developing.</p>

                <p className="value-page-text">On the home page, I wanted to replicate the colorful dashed line swirl that was shown on the slides, as seen below. How to create this as well as how to display it correctly with my other page elements had me stumped. My workaround for this was to download a similar image from the Maxx Potential site html, crop it to a similar shape as I desired, and use it as a background image. It's a rough approximation of the original, but not a replica. This is definitely something I would seek help on if I had to do it in a professional context.</p>
