...
export function Initiative() {
    return (
        <div className="value-page">
            ...
            <h1 className="value-page-heading">INITIATIVE: Goes above and beyond without being asked</h1>
            <img src={head5} alt="head5"/>

            <div className="value-page-container">
                <p className="value-page-text">On the heels of my Collab Lab experience, and with a hunger for more collaborative coding experience, I signed up for a beginner-friendly hackathon with <a href="https://girldevelopit.com/" target="_blank" rel="noreferrer">Girl Develop It</a>, an organization that supports women and non-binary folks entering careers in tech. I hoped I would find a team that I could contribute to with an idea I was interested in. During the idea pitch process, I suggested building a yoga "pose of the day" app, and the idea garnered significant interest. We decided to move forward with the idea, and I became the team leader.</p>
